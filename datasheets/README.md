...
Reference datasheets for the main ICs on the **Waveshare ESP32-S3-Touch-AMOLED-1.8** dev board and the project's external sensors. PDFs present in this folder are linked directly; the rest link to the manufacturer's page (some vendors — Analog Devices, X-Powers, Everest, FocalTech, Sitronix — block automated download, so grab those manually if you want local copies).
...
| **SH8601** (Sitronix) | 1.8" AMOLED display driver (368×448) | QSPI | via [board wiki resources](https://www.waveshare.com/wiki/ESP32-S3-Touch-AMOLED-1.8) |
...
| **QMI8658** (QST) | 6-axis IMU (accel + gyro) — wrist actigraphy | I²C `0x6A/0x6B` | [datasheet PDF](QMI8658_QST.pdf) · [QST](https://www.qstcorp.com/) |
...
**I²C bus map (no conflicts):** ES8311 `0x18` · AXP2101 `0x34` · FT3168 `0x38` · PCF85063 `0x51` · MAX30101/30102 `0x57` · QMI8658 `0x6A/0x6B`.
